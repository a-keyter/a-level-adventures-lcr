...
// All adventure data is written and read only through these validated server
// functions, so we use the privileged server client and keep the tables closed
// to direct public API access.
